...
namespace EniacSpi.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(List<LoginViewUserModel> model, string UserIndex, string returnUrl)
        {
            ...
            if (user != null)
            {
                if (!user.AccountConfirmed)
                {
                    ...
                    TempData["Message"] = "An access request has been send to the local administrators.";
                ...
                if (!await UserManager.IsEmailConfirmedAsync(user.Id))
                {
                    ...
                    TempData["Message"] = "A confirmation email has been send. Please check your mail";
        ...
        private async Task ConfirmAccount(ApplicationUser user)
        {
            ...
            foreach (var User in UserManager.Users.ToList())
            {
                ...
                {
                    await UserManager.SendEmailAsync(User.Id, "confirm Account", String.Format("Dear Moderator,<br /><br />The following user has registered to your Spi network:<br />{0}<br />{1}<br /><br />Confirm this account by clicking <a href=\"{2}\">here</a>",
                             user.UserName,
                             user.Email,
                             callbackUrl
                         ));
